    ...
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-4">
      ...
      <div>
        ...
        <select
          ...
          className="text-black bg-white border border-white/10 p-2 rounded w-full"
        >
      ...
      <div>
        ...
        <input
          ...
          className="w-full text-gray-200 border border-white/10 bg-transparent p-2 rounded cursor-pointer"
        />
      </div>
      <button
        type="submit"
